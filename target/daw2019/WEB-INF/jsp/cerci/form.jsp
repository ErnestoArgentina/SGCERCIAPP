...
<html>
    ...
    <head>
        ...
        <title>+ Educadores| SGCERCI</title>
        <!-- Favicon-->
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                ...
                                <div class="body">
                                     <form name="reg_users" id="form_validation"   action="<c:url value='/cerci/add'/>">
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                ...
                                                <input type="text" name="entity.nome" id="v_username" class="input-sm form-control" value="${entity.nome}">
                                            </div>
                                        </div>
                                 <div class="form-group form-float">
                                            <div class="form-line">
                                                <label for="v_street">Especialidade</label>
                                            </div>
                                        </div>
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <select class="required" name="entity.perfil">
                                                    <option value="slecione">Selecione a Especialidade</option>
