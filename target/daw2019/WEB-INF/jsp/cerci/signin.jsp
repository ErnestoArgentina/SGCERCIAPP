...
<body class="login-page">
    <div class="login-box">
        ...
        <div class="card">
            <div class="body">
                <form id="sign_in" action="<c:url value='/cerci/entrar'/>">
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="text" class="form-control" name="entity.telefone1" placeholder="Email" required autofocus>
                        </div>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">
                    ...
                    <div class="row m-t-15 m-b--20">
                        <div class="col-xs-6">
                            <a href="${pageContext.request.contextPath}/cerci/registar">Reigista-se!</a>
                        </div>
