<%-- 
    Document   : listgroup
    Created on : 18-Oct-2019, 22:23:46
    Author     : bONGANI
--%>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <ul class="list-group">
                                    <li class="list-group-item">Regula as necessidades básicas (sono,fome,..=</li>
                                    <li class="list-group-item">Colaborar com os adultos nas tarefas quotidianas</li>
                                    <li class="list-group-item">Recolher jogos, e arrumar as coisas no devido lugar</li>
                                    <li class="list-group-item">Desenvolver condutas de integração emgrupo_</li>
                                    <li class="list-group-item">Adquirir hábitos de cuidado, relacionados com higiene pessoal</li>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <ul class="list-group">
                                    <li class="list-group-item">Conhecer partes principais do corpo</li>
                                    <li class="list-group-item"></li>
                                    <li class="list-group-item"></li>
                                    <li class="list-group-item"></li>
                                    <li class="list-group-item">Organ</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <div class="list-group">
                                    <ul class="list-group">
                                        <li class="list-group-item">Consegue concluir as formas gemétricas</li>
                                        <li class="list-group-item">Compreende o que é dito</li>
                                        <li class="list-group-item">Imaginação?</li>
                                        <li class="list-group-item">Percepção?</li>
                                        <li class="list-group-item"></li>
                                    </ul></div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <div class="list-group">
                                    <ul class="list-group">
                                        <li class="list-group-item">Conhece formas geométricas</li>
                                        <li class="list-group-item"></li>
                                        <li class="list-group-item">Distingue ntamanhos</li>
                                        <li class="list-group-item">Faz cálculo usando adição e subtração</li>
                                        <li class="list-group-item"></li>
                                        <li class="list-group-item"></li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <div class="list-group">
                                    <ul class="list-group">
                                        <li class="list-group-item">Conhece o alfabeto</li>
                                        <li class="list-group-item">Reconhece as palavras</li>
                                        <li class="list-group-item">Lê textos simples</li>
                                        <li class="list-group-item">Faz cálculo usando adição e subtração</li>
                                        <li class="list-group-item"></li>
                                        <li class="list-group-item"></li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <div class="list-group">
                                    <ul class="list-group">
                                        <li class="list-group-item">Gostar de ouvir música</li>
                                        <li class="list-group-item">Toca em algum instrumento</li>
                                        <li class="list-group-item">Interpreta canções simples</li>
