...
<html>
    ...
    <body>
        ...
        <div class="tab-pane" id="mbox_new">
            <form name="reg_users" id="new_message_form" class="form-horizontal" action="<c:url value='/educador/add'/>">
                <div class="col-md-3">
                </div>
                ...
                <div class="col-md-6"> 
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" name="nome" id="v_username" class="input-sm form-control">
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <select class="required" name="entity.perfil">
                            ...
                            <option value="Administrador">Educador</option>
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" name="entity.data_nascimento" id="v_username" class="input-sm form-control">
                    </div>
                    
                    <div class="col-md-12">
                        <label>Especialidade</label>
                        <input type="number" name="entity.especialidade" id="v_username" class="input-sm form-control">
                    </div>
                    
                    <div class="col-md-12">
                        <label>Nacionalidade</label>
                        <input type="text" name="entity.nacionalidade" id="v_username" class="input-sm form-control">
                    </div>
                    
                    <div class="col-md-12">
                        <label>Observações</label>
                        <input type="number" name="entity.observacoes" id="v_username" class="input-sm form-control">
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        ...
                        <br>
                        <div class="col-md-12">
                            <button type="submit" class="btn btn-primary">Gravar Educador</button>
                        </div>
                    </div>
