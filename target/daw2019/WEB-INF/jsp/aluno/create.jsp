                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                ...
                                <div class="body">
                                    <form name="reg_users" id="form_validation"   action="<c:url value='/aluno/add'/>">
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <label for="v_street">Raça</label>
                                                 <select class="required" name="entity.raca">
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <label for="v_street">Raça</label>
                                                <select class="required" name="entity.idEncarregado">
                                                    <option value="slecione">Selecione o encarregado</option>
