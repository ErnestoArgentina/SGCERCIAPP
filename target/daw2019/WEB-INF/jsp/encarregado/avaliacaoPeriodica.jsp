...
<!--                            
                            <li>
                                <a href="${pageContext.request.contextPath}/educador/perfilEducador">Perfil de Alunos</a>
                            </li>-->
                                    ...
                                    <tbody>
                                        <c:forEach items="${list}" var="entity">
                                            <tr class="read">
                                                ...
                                                <td>${entity.perfil}</td>
                                                <td>
                                                    <a class="btn btn-alert" href="avPeriodicaAluno?id=${entity.id}"> avaliar</a>
                                                    <a class="btn btn-success" href="avPeriodicaAlunoLista?id=${entity.id}"> listar avaliacoes</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
