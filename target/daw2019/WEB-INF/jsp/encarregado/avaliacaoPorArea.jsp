                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>
                                    Lista dos alunos (Avaliacao por area)
                                </h2>
                                    ...
                                    <tbody>
                                        <c:forEach items="${list}" var="entity">
                                            <tr class="read">
                                                ...
                                                <td>${entity.perfil}</td>
                                                <td>
                                                    <a class="btn btn-primary" href="avaliacaoPorAreaAluno?id=${entity.id}"> avaliar</a>
                                                    <a class="btn btn-success" href="avaliacaoPorAreaAlunoLista?id=${entity.id}"> ver avaliacoes</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
