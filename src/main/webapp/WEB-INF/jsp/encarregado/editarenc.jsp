                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <div class="body">
                                    <form name="reg_users" id="form_validation"   action="<c:url value='/cerci/editarencarregado1'/>">


                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" name="id" id="v_username" class="input-sm form-control" value="${entity.id}">
                                                 <!--<input type="number" name="id" id="v_username" value="entity.id" class="input-sm form-control">-->
                                                <label for="v_street">Nome Completo</label>
                                                <input type="text" name="nome" id="v_username" class="input-sm form-control" value="${entity.nome}">
                                            </div>
                                        </div>
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <select class="required" name="entity.perfil">
                                                    <option value="slecione">Seleciona o educando</option>
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                ...
                                                <input type="number" name="entity.telefone1" id="v_username" value="entity.telefone1" class="input-sm form-control">
                                            </div>
                                        </div>
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <label for="v_street">Senha</label>
                                                <input class="input-sm form-control" name="entity.senha" value="entity.senha"id="v_city" type="password">
                                            </div>
                                            <div class="form-line">
                                                <label for="v_street">Confirma Senha</label>
                                                <input class="input-sm form-control" name="ea" id="v_city" type="password">
                                            </div>
                                        </div>
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <label for="v_street">Observações</label>
                                                <input class="input-sm form-control" name="aluno" id="v_city" type="text">
                                            </div>
                                        </div>
