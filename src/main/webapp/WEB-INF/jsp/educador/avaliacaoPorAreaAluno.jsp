...
<html>
    ...
    <body class="theme-red">
        ...
        <section class="content">
             <form  action="<c:url value='/educador/addAvaliacaoPorArea'/>">
                                    ...
                                    <div class="list-group">
                                        <ul class="list-group">
                                            <li class="list-group-item">Consegue concluir as formas gemétricas
                                                <select name="entity.concluiFormasGenericas">
                                                    <option value="Sim">Sim</option>
                                                    <option value="Nao">Nao</option>
                                                </select>
                                            </li>
                                            <li class="list-group-item">Compreende o que é dito
                                                <select name="entity.compreendeOqueEDito">
                                                    <option value="Sim">Sim</option>
                                                    <option value="Nao">Nao</option>
                                                </select>
                                            </li>
                                ...
                                <div class="list-group">
                                    <ul class="list-group">
                                        <li class="list-group-item">Conhece o alfabeto
                                            <select name="entity.conheceAlfabeto">
                                                <option value="Sim">Sim</option>
                                                <option value="Nao">Nao</option>
                                            </select>
                                        </li>
                                        <li class="list-group-item">Reconhece as palavras
                                            <select name="entity.reconhecePalavras">
                                                <option value="Sim">Sim</option>
                                                <option value="Nao">Nao</option>
                                            </select>
                                        </li>
                                        <li class="list-group-item">Lê textos simples
                                            <select name="entity.leTextosSimples">
                                                <option value="Sim">Sim</option>
                                                <option value="Nao">Nao</option>
                                            </select>
                                        </li>
                                ...
                                <div class="list-group">
                                    <ul class="list-group">
                                        <li class="list-group-item">Gostar de ouvir música
                                            <select name="entity.gostaDeMusica">
                                                <option value="Sim">Sim</option>
                                                <option value="Nao">Nao</option>
                                            </select>
                                        </li>
                                        <li class="list-group-item">Toca em algum instrumento
                                            <select name="entity.tocaIstrumentos">
                                                <option value="Sim">Sim</option>
                                                <option value="Nao">Nao</option>
                                            </select>
                                        </li>
                                        <li class="list-group-item">Interpreta canções simples
                                            <select name="entity.interpretaCancoesSimples">
                                                <option value="Sim">Sim</option>
                                                <option value="Nao">Nao</option>
                                            </select>
                                        </li>
