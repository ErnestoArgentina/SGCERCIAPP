            ...
            <aside id="leftsidebar" class="sidebar">
                ...
                <div class="user-info">
                    ...
                    <div class="info-container">
                        <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Biote Ngovene ${Sessao.nomeEducadorLogado}</div>
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="block-header">
                        <h2>Modelo de Avaliação Periódica do Utente ${aluno.nome}</h2>
                    </div>
                                ...
                                <div class="body">
                                    <ul class="list-group">
                                        <li class="list-group-item">Temperamento? 
                                            <button class="btn btn-alert">  ${avaliacao.temperamento} </button>
                                        </li>
                                        <li class="list-group-item">Comportamento?
                                            <button class="btn btn-alert">  ${avaliacao.comportamento} </button>
                                        </li>
                                        <li class="list-group-item">Relacionamento com outras Crianças?
                                            <button class="btn btn-alert">  ${avaliacao.relacaoOutrasCriancas} </button>
                                        </li>
                                        <li class="list-group-item">Participação no grupo
                                            <button class="btn btn-alert">  ${avaliacao.participacaoGrupo} </button>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="body">
                                    <ul class="list-group">
                                        <li class="list-group-item">Come com apoio do Educador(a)?
                                            <button class="btn btn-primary">  ${avaliacao.comeComEducador} </button>
                                        </li>
                                        <li class="list-group-item">Posição na Mesa?
                                            <button class="btn btn-primary">  ${avaliacao.posicaoNaMesa} </button>
                                        </li>
                                        <li class="list-group-item">Uso de Talheres?
                                            <button class="btn btn-primary">  ${avaliacao.usaTalheres} </button>
                                        </li>
                                        <li class="list-group-item">Higiene Corporal?
                                            <button class="btn btn-primary">  ${avaliacao.higienePessoal} </button>
