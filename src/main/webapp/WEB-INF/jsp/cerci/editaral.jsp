            ...
            <div class="container-fluid">
                <div class="block-header">
                    <h2>
                        ...
                        <small>Obtido em <a href="https://github.com/rstaib/jquery-steps" target="_blank">github.com/rstaib/jquery-steps</a> & <a href="https://jqueryvalidation.org/" target="_blank">jqueryvalidation.org</a></small>
                    </h2>
                </div>
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <!--form id="form_validation" action="<c:url value='/cerci/add'/>">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="email" class="form-control" name="entity.telefone1" required>
                                            <label class="form-label">Email</label>
                                        </div>
                                    </div>
                                <!--div class="form-group">
                                    <input type="radio" name="entity.genero" id="male" class="with-gap">
                                    <label for="male">Masculino</label>

                                    <input type="radio" name="entity.genero" id="female" class="with-gap">
                                ...
                                <!--div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="entity.perfil" required>
                                ...
                                <div class="body">
                                    <form name="reg_users" id="form_validation"   action="<c:url value='/cerci/editaraluno1'/>">


                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" name="id" id="v_username" class="input-sm form-control" value="${entity.id}">
                                                <label for="v_street">Nome Completo</label>
                                                <input type="text" name="nome" value="${entity.nome}" id="v_username" class="input-sm form-control">
                                            </div>
                                        </div>
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <label for="v_street">Raça</label>
                                            </div>
                                        </div>
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <select class="required" name="perfil" value="${entity.perfil}">
                                                    <option value="slecione">Selecione a Raça</option>
                                        ...
                                        <div class="form-group form-float">
                                        <div class="form-line">
                                                 <label for="v_street">Idade</label>
                                            <input class="input-sm form-control" name="entity.senha" id="v_city" type="text">
                                        </div>
                                        </div>
                                        <div class="form-group form-float">
                                        <div class="form-line">
                                                  <label for="v_street">Nacionalidade</label>
                                            <input class="input-sm form-control" name="entity.aluno" id="v_city" type="text">
                                        </div>
                                        </div>
