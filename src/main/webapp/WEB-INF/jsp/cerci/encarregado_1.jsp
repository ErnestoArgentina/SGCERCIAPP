                                ...
                                <div class="body">
                                    <form name="reg_users" id="form_validation" action="<c:url value='/cerci/addpai'/>">
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <!--<input type="text" name="id" id="v_username" class="input-sm form-control" value="">-->
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                ...
                                                <input class="input-sm form-control" name="entity.senha" value="" id="v_city" type="password">
                                            </div>
                                            <div class="form-line">
