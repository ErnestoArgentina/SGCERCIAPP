...
<html>
    ...
    <head>
        ...
        <title>Lista Encerregados | SGCERCI</title>
        <!-- Favicon-->
                                    ...
                                    <tbody>
                                        <c:forEach items="${list}" var="entity">
                                            <tr class="read">
                                                ...
                                                <td>${entity.perfil}</td>
                                                <td>
                                                   <button type="button"  class="material-icons" data-toggle="modal" data-target="#myModal"><a href="editarencarregado?id=${entity.id}"/> add</button>
                                                   <button type="button"  class="material-icons" data-toggle="modal" data-target="#myModal"><a href="remove?id=${entity.id}"/> Delete</button>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
