    ...
    <section class="content">
            <div class="container-fluid">
                <div class="block-header">
                    <h2>Modelo de Avaliação Periódica do Utente</h2>
                </div>
                <div class="row clearfix">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <ul class="list-group">
                                    <li class="list-group-item">Temperamento?</li>
                                    <li class="list-group-item">Comportamento?</li>
                                    <li class="list-group-item">Relacionamento com outras Crianças?</li>
                                    <li class="list-group-item">Participação no grupo_</li>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <ul class="list-group">
                                    <li class="list-group-item">Come com apoio do Educador(a)?</li>
                                    <li class="list-group-item">Posição na Mesa?</li>
                                    <li class="list-group-item">Uso de Talheres?</li>
                                    <li class="list-group-item">Higiene Corporal?</li>
                                    <li class="list-group-item">Organizado e Serve de exemplo?</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="body">
                                <div class="list-group">
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item">Memória?</li>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <div class="list-group">
                                    <ul class="list-group">
                                        <li class="list-group-item">Coordenação do Movimentos?</li>
                                        <li class="list-group-item">Destreza Manual?</li>
                                        <li class="list-group-item">Equilíbrio Global</li>
                                        <li class="list-group-item"></li>
                                        <li class="list-group-item"></li>
                                        <li class="list-group-item"></li>
