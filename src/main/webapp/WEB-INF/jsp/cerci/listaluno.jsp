        ...
        <section class="content">
            <div class="container-fluid">
                <div class="block-header">
                    <h2>
                        ALUNOS
                        <small>Taken from <a hEncarregadosref="https://datatables.net/" target="_blank">datatables.net</a></small>
                    </h2>
                </div>
                <!-- Exportable Table -->
                                    ...
                                    <tbody>
                                        <c:forEach items="${list}" var="entity">
                                            <tr class="read">
                                                ...
                                                <td>${entity.perfil}</td>
                                                <td>
                                                    <button type="button"  class="material-icons" data-toggle="modal" data-target="#myModal"><a href="editaraluno?id=${entity.id}"/> editar</button>
                                                    <button type="button"  class="material-icons" data-toggle="modal" data-target="#myModal"><a href="removeal?id=${entity.id}"/> eliminar</button>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
