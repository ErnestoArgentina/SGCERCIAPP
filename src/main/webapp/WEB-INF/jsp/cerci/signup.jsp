<%-- 
    Document   : signup
    Created on : 19-Oct-2019, 06:54:22
    Author     : bONGANI
--%>
...
<body class="signup-page">
            ...
            <div class="body">
                <form id="sign_up" method="POST">
                    ...
                    <div class="m-t-25 m-b--5 align-center">
                        <a href="${pageContext.request.contextPath}/cerci/login">You already have a membership?</a>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script src="${pageContext.request.contextPath}/resources/view/js/pages/examples/sign-up.js"></script>
</body>
