 ...
 */
@Entity
@Table (name="tb_doente")/*, uniqueConstraints={
...
public class Doente implements Serializable{
    ...
    private int idEncarregado;

    public int getIdEncarregado() {
        return idEncarregado;
    }

    public void setIdEncarregado(int idEncarregado) {
